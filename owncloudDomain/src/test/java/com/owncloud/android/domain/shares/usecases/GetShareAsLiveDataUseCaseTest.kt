...
class GetShareAsLiveDataUseCaseTest {
    ...
    fun getShareAsLiveDataOk() {
        ...
        every { shareRepository.getStoredShare(any()) } returns shareLiveData

        val shareToEmit = listOf(DUMMY_SHARE)
    ...
    fun getShareAsLiveDataException() {
        every { shareRepository.getStoredShare(any()) } throws Exception()
