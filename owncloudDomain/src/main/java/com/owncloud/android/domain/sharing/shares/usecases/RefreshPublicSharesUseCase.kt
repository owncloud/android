...
class RefreshPublicSharesUseCase(
    context: Context,
    account: Account,
...
) : BaseUseCase<Unit, RefreshPublicSharesUseCase.Params>() {

    override fun run(params: Params): UseCaseResult<Unit> {
        val dataResult = shareRepository.refreshPublicShares(params.filePath, params.accountName)
