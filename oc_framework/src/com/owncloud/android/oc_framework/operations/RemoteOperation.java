...
/**
 * Operation which execution involves one or several interactions with an
 * ownCloud server.
 * 
 * Provides methods to execute the operation both synchronously or
 * asynchronously.
 * 
...
public abstract class RemoteOperation implements Runnable {
    ...
    /**
     * Synchronously executes the remote operation on the received ownCloud
     * account.
     * 
     * Do not call this method from the main thread.
     * 
     * This method should be used whenever an ownCloud account is available,
     * instead of {@link #execute(WebdavClient)}.
     * 
     * @param account
     *            ownCloud account in remote ownCloud server to reach during the
     *            execution of the operation.
     * @param context
     *            Android context for the component calling the method.
     ...
     * 
     * @param client
     *            Client object to reach an ownCloud server during the execution
     *            of the operation.
     * @return Result of the operation.
     */
     ...
     *            Android context for the component calling the method.
     * @param listener
     *            Listener to be notified about the execution of the operation.
     * @param listenerHandler
     *            Handler associated to the thread where the methods of the
     *            listener objects must be called.
    ...
    public final Thread execute(Account account, Context context, OnRemoteOperationListener listener,
        ...
        mClient = null; // the client instance will be created from mAccount and
                        // mContext in the runnerThread to create below
    ...
    /**
     * Synchronously retries the remote operation using the same WebdavClient in
     * the last call to {@link RemoteOperation#execute(WebdavClient)}
     * 
     * @param listener
     *            Listener to be notified about the execution of the operation.
     * @param listenerHandler
    ...
    /**
     * Asynchronously retries the remote operation using the same WebdavClient
     * in the last call to
     * {@link RemoteOperation#execute(WebdavClient, OnRemoteOperationListener, Handler)}
     * 
     * @param listener
     *            Listener to be notified about the execution of the operation.
     * @param listenerHandler
    ...
    /**
     * Asynchronous execution of the operation started by
     * {@link RemoteOperation#execute(WebdavClient, OnRemoteOperationListener, Handler)}
     * , and result posting.
     * 
    ...
    public final void run() {
        ...
        do {
            try {
                ...
                Log.e(TAG, "Error while trying to access to " + mAccount.name, new AccountsException(
                        "I/O exception while trying to authorize the account", e));
            ...
            // (result.isTemporalRedirection() && result.isIdPRedirection()))) {
                ...
                // / possible fail due to lack of authorization in an operation
                ...
                if (cred != null || ssoSessionCookie != null) {
                    ...
                    mClient = null;
                    repeat = true; // when repeated, the creation of a new
                                   // OwnCloudClient after erasing the saved
                                   // credentials will trigger the login
                                   // activity
                    result = null;
                }
            }
