...
/**
 * Remote operation performing the read of remote file or folder in the ownCloud
 * server.
 * 
...
public class ReadRemoteFolderOperation extends RemoteOperation {
    ...
    protected RemoteOperationResult run(WebdavClient client) {
        ...
        try {
            ...
            if (query != null)
                query.releaseConnection(); // let the connection available for
                                           // other methods
            if (result.isSuccess()) {
    ...
    /**
     * Read the data retrieved from the server about the contents of the target
     * folder
     * 
     * 
     * @param dataInServer
     *            Full response got from the server with the data of the target
     *            folder and its direct children.
     * @param client
     *            Client instance to the remote server where the data were
     *            retrieved.
     * @return
     */
     ...
     * 
     * @param we
     *            WebDAV entry read from the server for a WebDAV resource
