...
public class BearerAuthScheme implements AuthScheme /* extends RFC2617Scheme */{
     ...
     *             Thrown if the authentication challenge is malformed
     * 
     ...
     * 
     * @return 'true' if Bearer authorization has been processed, 'false'
     *         otherwise.
     */
     ...
     * @param method
     *            Method name is ignored by the bearer authentication scheme
     * @param uri
     *            URI is ignored by the bearer authentication scheme
    ...
    public String authenticate(Credentials credentials, String method, String uri) throws AuthenticationException {
        ...
        try {
            ...
            throw new InvalidCredentialsException("Credentials cannot be used for bearer authentication: "
    ...
    public static String authenticate(BearerCredentials credentials, String charset) {
        ...
        // return "Bearer " +
        // EncodingUtil.getAsciiString(EncodingUtil.getBytes(buffer.toString(),
        // charset));
