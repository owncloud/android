...
/**
 * Enables the support of Server Name Indication if existing in the underlying
...
public class ServerNameIndicator {
     ...
     * 
     * @param sslSocketClass
     *            Underlying implementation class of {@link SSLSocket} used to
     *            connect with the server.
     * @param setHostnameMethod
     *            Name of the method to call to enable the SNI support.
     */
    ...
    /**
     * Calls the {@code #setHostname(String)} method of the underlying
     * implementation of {@link SSLSocket} if exists.
     * 
     * Creates and initializes the single instance of the class when needed
     * 
     * @param hostname
     *            The name of the server host of interest.
     * @param sslSocket
     *            Client socket to connect with the server.
     */
    ...
    /**
     * Gets the method to invoke trying to minimize the effective application of
     * reflection.
     * 
     * @param sslSocket
     *            Instance of the SSL socket to use in connection with server.
     * @return Method to call to indicate the server name of interest to the
     *         server.
     */
     ...
     * 
     * Uses reflection to extract and 'cache' the method to invoke to indicate
     * the desited host name to the server side.
     * 
     * @param sslSocketClass
     *            Underlying class providing the implementation of
     *            {@link SSLSocket}.
     * @return Method to call to indicate the server name of interest to the
     *         server.
     */
