...
public class OwnCloudAccount extends Account {
    ...
    public static class Constants {
         ...
         * {@link com.owncloud.android.authentication.AuthenticatorActivity.KEY_OC_BASE_URL}
         * and
        ...
        /**
         * Flag signaling if the ownCloud server can be accessed with OAuth2
         * access tokens.
         */
        public static final String KEY_SUPPORTS_OAUTH2 = "oc_supports_oauth2";
        /**
         * Flag signaling if the ownCloud server can be accessed with session
         * cookies from SAML-based web single-sign-on.
         */
