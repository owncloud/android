...
package com.owncloud.android.data.sharing.shares.presentation
...
import com.owncloud.android.data.sharing.shares.domain.OCShareRepository
...
class OCShareViewModelTest {
    ...
    fun loadPrivateShares() {
        ...
        val resource: Resource<List<OCShareEntity>>? = ocShareViewModel.getPrivateShares(filePath).value
    ...
    fun loadPublicShares() {
        ...
        val resource: Resource<List<OCShareEntity>>? = ocShareViewModel.getPublicShares(filePath).value
