...
class OCRemoteShareeDataSourceTest {
    private lateinit var ocRemoteShareesDataSource: com.owncloud.android.data.sharing.sharees.datasources.OCRemoteShareesDataSource
    private val ownCloudClient = mock(OwnCloudClient::class.java)

    @Before
    fun init() {
        ocRemoteShareesDataSource = com.owncloud.android.data.sharing.sharees.datasources.OCRemoteShareesDataSource(ownCloudClient)
    }
