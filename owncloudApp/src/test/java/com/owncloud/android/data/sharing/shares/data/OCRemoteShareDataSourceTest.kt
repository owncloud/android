...
package com.owncloud.android.data.sharing.shares.data
...
class OCRemoteShareDataSourceTest {
    private lateinit var ocRemoteSharesDataSource: com.owncloud.android.data.sharing.shares.datasources.OCRemoteSharesDataSource
    private val ownCloudClient = mock(OwnCloudClient::class.java)

    @Before
    fun init() {
        ocRemoteSharesDataSource = com.owncloud.android.data.sharing.shares.datasources.OCRemoteSharesDataSource(ownCloudClient)
    }
