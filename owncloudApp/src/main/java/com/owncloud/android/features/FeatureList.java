...
public class FeatureList {
    ...
    static final private String VERSION_NAME_2_17 = "2.17.0";
    ...
    static final private FeatureItem[] featuresList = {
            ...
            new FeatureItem(R.drawable.whats_new_avatar_toolbar, R.string.welcome_feature_6_title,
                    R.string.welcome_feature_6_text, VERSION_NAME_2_17, INDIFFERENT, SHOW_ON_UPGRADE)
    };
