...
public class EditShareFragment extends DialogFragment {
     ...
     *
     * @param shareToEdit   An {@link OCShareEntity} to show and edit in the fragment
     ...
     */
    public static EditShareFragment newInstance(OCShareEntity shareToEdit, OCFile sharedFile, Account account) {
