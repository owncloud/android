...
import com.owncloud.android.domain.sharing.shares.usecases.GetShareesUseCase
...
class OCShareeViewModel(
    val context: Context,
    account: Account,
    private val getShareesUseCase: GetShareesUseCase = GetShareesUseCase(context, account)
) : ViewModel() {
