...
class FileDetailFragment : FileFragment(), View.OnClickListener {
    ...
    private val fileDetailViewModel: FileDetailViewModel by viewModel()
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fileDetailViewModel.capabilities.observe(viewLifecycleOwner) { ocCapability: OCCapability? ->
        ...
        fileDetailViewModel.openInWebUriLiveData.observe(viewLifecycleOwner, Event.EventObserver<UIResult<String>> { uiResult: UIResult<String?> ->
    ...
    override fun onPrepareOptionsMenu(menu: Menu) {
        ...
        if (item != null) {
            item.isVisible = fileDetailViewModel.isOpenInWebAvailable()
            item.isEnabled = fileDetailViewModel.isOpenInWebAvailable()
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        return when (item.itemId) {
            ...
            R.id.action_open_in_web -> {
                fileDetailViewModel.openInWeb(file.remoteId!!)
                true
            }
