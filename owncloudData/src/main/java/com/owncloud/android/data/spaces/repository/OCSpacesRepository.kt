...
class OCSpacesRepository(
    ...
    override fun refreshSpacesForAccount(accountName: String, userId: String, userGroups: List<String>) {
        remoteSpacesDataSource.refreshSpacesForAccount(accountName, userId, userGroups).also { listOfSpaces ->
    ...
    override fun editSpaceImage(accountName: String, spaceId: String, imageId: String) {
        remoteSpacesDataSource.editSpaceImage(accountName, spaceId, imageId)
    }
    ...
    override fun enableSpace(accountName: String, spaceId: String) {
        remoteSpacesDataSource.enableSpace(accountName, spaceId)
    }
