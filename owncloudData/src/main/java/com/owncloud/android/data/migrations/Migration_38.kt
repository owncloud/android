...
val MIGRATION_37_38 = object : Migration(37, 38) {
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL("CREATE TABLE IF NOT EXISTS `files_sync` (`idFile` INTEGER NOT NULL, `uploadWorkerUuid` BLOB NOT NULL, `downloadWorkerUuid` BLOB NOT NULL, `isSynchronizing` INTEGER NOT NULL, PRIMARY KEY(`idFile`), FOREIGN KEY(`idFile`) REFERENCES `files`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE )")
    }
}
