...
class OCShareRepositoryTest {
    ...
    fun getStoredSharesOk() {
        ...
        ocShareRepository.getStoredShares(filePath, accountName).observeForever {
    ...
    fun getStoredSharesException() {
        ...
        val sharesEmitted = mutableListOf<List<OCShare>>()
        ocShareRepository.getStoredShares(filePath, accountName)
    ...
    fun getStoredShareOk() {
        ...
        ocShareRepository.getStoredShare(1).observeForever {
            sharesEmitted.add(it!!)
        }
    ...
    fun getStoredShareException() {
        ...
        val sharesEmitted = mutableListOf<OCShare>()
        ocShareRepository.getStoredShare(1)
