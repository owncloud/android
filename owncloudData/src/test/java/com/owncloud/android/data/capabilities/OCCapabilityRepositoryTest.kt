...
import com.owncloud.android.data.capabilities.datasources.RemoteCapabilitiesDataSourceTest
...
//    }
    ...
    @Test
    fun fetchCapabilityFromNetwork() {
        val defaultAccountName = "admin@server"

        val capability = DataTestUtil.createCapability(defaultAccountName)
        val remoteCapabilitiesDataSource = RemoteCapabilitiesDataSourceTest(capability)
...
//        verify {
//            localCapabilitiesDataSource.insert(
//                listOf(OCCapabilityEntity.fromRemoteCapability(capability.apply {
//                    accountName = defaultAccountName
//                }))
//            )
//        }
