...
public class TestActivity extends Activity {
     ...
     * 
     * @param remotePath
     *            Full path to the new directory to create in the remote server.
     * @param createFullPath
     *            'True' means that all the ancestor folders should be created
     *            if don't exist yet.
     * 
     * @return
     */
     ...
     * @param oldRemotePath
     *            Old remote path of the file. For folders it starts and ends by
     *            "/"
     * @param newName
     ...
     * 
     * @param remotePath
     *            Remote path of the file or folder in the server.
     * @return
     */
    ...
    public RemoteOperationResult downloadFile(RemoteFile remoteFile, String temporalFolder) {
        ...
        DownloadRemoteFileOperation downloadOperation = new DownloadRemoteFileOperation(remoteFile,
