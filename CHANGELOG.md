...
[unreleased]: https://github.com/owncloud/android/compare/v4.8.4...master

## Summary

* Bugfix - Spaces search filter for multi-personal accounts (Kiteworks accounts): [#4674](https://github.com/owncloud/android/issues/4674)
* Bugfix - Hide keyboard and clear error when brute-force countdown ends: [#4874](https://github.com/owncloud/android/issues/4874)
* Bugfix - Recalculate grid mode after rotation: [#4884](https://github.com/owncloud/android/issues/4884)
* Bugfix - Show the full description of space permissions: [#4968](https://github.com/owncloud/android/issues/4968)
...
* Change - Remove sonarqube dependency: [#4990](https://github.com/owncloud/android/pull/4990)
* Enhancement - New UI for oCIS sharing: [#4839](https://github.com/owncloud/android/issues/4839)
* Enhancement - Create a share over a file or a folder on an oCIS server: [#4875](https://github.com/owncloud/android/issues/4875)
* Enhancement - List shares for oCIS accounts: [#4876](https://github.com/owncloud/android/issues/4876)
* Enhancement - Remove a share over a file or a folder on an oCIS server: [#4940](https://github.com/owncloud/android/issues/4940)
* Enhancement - Back gesture to go up a folder: [#4943](https://github.com/owncloud/android/pull/4943)
* Enhancement - Add header to remove member dialog: [#4989](https://github.com/owncloud/android/pull/4989)

## Details

* Bugfix - Spaces search filter for multi-personal accounts (Kiteworks accounts): [#4674](https://github.com/owncloud/android/issues/4674)

   All matching personal spaces have been included in the spaces search filter for
   multi-personal accounts.
...
* Bugfix - Hide keyboard and clear error when brute-force countdown ends: [#4874](https://github.com/owncloud/android/issues/4874)
   ...
   The number keyboard has been hidden during the brute-force protection countdown
   so users cannot interact with it. The wrong-passcode error message has been
   cleared once the countdown ends, leaving a clean screen for the next attempt.
...
* Bugfix - Show the full description of space permissions: [#4968](https://github.com/owncloud/android/issues/4968)
   ...
   More room has been given to the description of a role in the space member
   permissions list, so longer descriptions are no longer cut after the second
   line, and any text that still does not fit is ellipsized.
...
* Change - Remove sonarqube dependency: [#4990](https://github.com/owncloud/android/pull/4990)
   ...
   Sonarqube dependency has been removed since it's no longer used

   https://github.com/owncloud/android/pull/4990
...
* Enhancement - Create a share over a file or a folder on an oCIS server: [#4875](https://github.com/owncloud/android/issues/4875)
   ...
   A new option to create a share over a file or a folder on an oCIS has been
   added. It will be only visible for users with proper permissions.
...
* Enhancement - List shares for oCIS accounts: [#4876](https://github.com/owncloud/android/issues/4876)
   ...
   A new UI has been implemented to list and show information about the shares of a
   file or folder on oCIS accounts (using Graph API)
...
* Enhancement - Remove a share over a file or a folder on an oCIS server: [#4940](https://github.com/owncloud/android/issues/4940)
   ...
   A new option to remove a share over a file or a folder on an oCIS has been
   added. It will be only visible for users with proper permissions.
...
* Enhancement - Back gesture to go up a folder: [#4943](https://github.com/owncloud/android/pull/4943)
   ...
   A new gesture has been added in the list of files to browse back to the parent
   folder instead of closing the app

   https://github.com/owncloud/android/pull/4943

* Enhancement - Add header to remove member dialog: [#4989](https://github.com/owncloud/android/pull/4989)

   A header has been added to the remove member from space dialog in order to be
   consistent with other removal dialogs

   https://github.com/owncloud/android/pull/4989
...
[4.8.1]: https://github.com/owncloud/android/compare/v4.8.0...v4.8.1
...
[4.8.0]: https://github.com/owncloud/android/compare/v4.7.0...v4.8.0
...
* Change - Weekly dependabot updates: [#4849](https://github.com/owncloud/android/pull/4849)
...
* Enhancement - Pull to refresh members and links: [#4773](https://github.com/owncloud/android/issues/4773)
...
* Change - Weekly dependabot updates: [#4849](https://github.com/owncloud/android/pull/4849)
   ...
   Dependabot workflow in GitHub Actions has been modified to be triggered weekly
   with maximum 5 PRs to be created
...
* Enhancement - Pull to refresh members and links: [#4773](https://github.com/owncloud/android/issues/4773)
   ...
   A pull to refresh has been added to the space members and links lists in order
   to refresh the data and permissions with a simple gesture.
