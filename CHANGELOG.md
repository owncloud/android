...
* Change - Added new unit test: [#4073](https://github.com/owncloud/android/issues/4073)
...
* Change - Added new unit test: [#4073](https://github.com/owncloud/android/issues/4073)
   ...
   Implementation of all functions within those classes (ScopedStorageProviderTest and
   OCSharedPreferencesProviderTest).
