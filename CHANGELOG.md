...
* Bugfix - Clear data button enabled in the App info: [#4309](https://github.com/owncloud/android/issues/4309)
   ...
   The clear data button have been enabled to delete the application data from the
   App info in the Settings app. Shared preferences, temporary files, accounts and
   the local database will be cleared when the button is pressed.
