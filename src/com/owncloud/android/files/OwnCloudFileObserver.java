...
public class OwnCloudFileObserver extends FileObserver {
    ...
    private void startSyncOperation() {
        ...
        OCFile file = storageManager.getFileByLocalPath(mPath); // a fresh
                                                                // object is
                                                                // needed; many
                                                                // things could
                                                                // have occurred
                                                                ...
                                                                // SOMETHING TO
                                                                // BE DONE;
        SynchronizeFileOperation sfo = new SynchronizeFileOperation(file, null, storageManager, mOCAccount, true,
                mContext);
