...
public class OCNotificationManager {
    ...
    enum NotificationType {
        NOTIFICATION_SIMPLE, NOTIFICATION_PROGRESS
    }
    ...
    public int postNotification(NotificationType type, NotificationData data) {
        ...
        case NOTIFICATION_SIMPLE:
            notification = new Notification(DisplayUtils.getSeasonalIconId(), data.getText(),
    ...
    public boolean updateNotification(int notification_id, NotificationData data) {
        ...
        switch (pair.mType) {
        case NOTIFICATION_PROGRESS:
            pair.mNotificaiton.contentView.setProgressBar(R.id.status_text, 100, data.getPercent(), false);
            return true;
        case NOTIFICATION_SIMPLE:
            pair.mNotificaiton = new Notification(DisplayUtils.getSeasonalIconId(), data.getText(),
                    System.currentTimeMillis());
