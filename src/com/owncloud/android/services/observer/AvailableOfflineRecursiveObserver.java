 ...
 *  be replaced.
 */
public class AvailableOfflineRecursiveObserver implements AvailableOfflineObserver {

    private static String TAG = AvailableOfflineRecursiveObserver.class.getSimpleName();
    ...
    */
     ...
     */
    public AvailableOfflineRecursiveObserver(String path, Account account, Context context) {
        if (path == null)
