...
public class PinCodeActivity extends SherlockFragmentActivity {
    ...
    // private int mTCounter ; // Count the number of attempts an user could
        ...
        if (state) {
            ...
            mBCancel.setOnClickListener(new OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    SharedPreferences.Editor appPrefsE = PreferenceManager.getDefaultSharedPreferences(
                ...
                if (s.length() > 0) {
                    ...
                    if (mPinCodeChecked
                        ...
                        if (newState.equals("false")) {
                            SharedPreferences.Editor appPrefs = PreferenceManager.getDefaultSharedPreferences(
                                    getApplicationContext()).edit();
    ...
    protected boolean checkPincode() {
        ...
        if (mTempText[0].equals(pText1) && mTempText[1].equals(pText2) && mTempText[2].equals(pText3)
    ...
    protected void confirmPincode() {
        ...
        if (mTempText[0].equals(rText1) && mTempText[1].equals(rText2) && mTempText[2].equals(rText3)
    ...
    protected void savePincodeAndExit() {
        SharedPreferences.Editor appPrefs = PreferenceManager.getDefaultSharedPreferences(getApplicationContext())
                .edit();
