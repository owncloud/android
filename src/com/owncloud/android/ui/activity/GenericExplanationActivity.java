...
/**
 * Activity showing a text message and, optionally, a couple list of single or
 * paired text strings.
 * 
 * Added to show explanations for notifications when the user clicks on them,
 * and there no place better to show them.
 * 
