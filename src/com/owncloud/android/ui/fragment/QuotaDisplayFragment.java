...
public class QuotaDisplayFragment extends SherlockFragment implements OnRemoteOperationListener {
    ...
    protected void setColorAndUsage(int percentage, ProgressBar progressBar) {
        ...
        if (percentage <= 50) {
            ...
            d = getResources().getDrawable(R.drawable.progressbar_circular_green);
        } else if (percentage >= 70 && percentage < 85) {
            d = getResources().getDrawable(R.drawable.progressbar_circular_orange);
        } else if (percentage >= 85 && percentage <= 100) {
            d = getResources().getDrawable(R.drawable.progressbar_circular_red);
        }
