...
public class ChangelogDialog extends SherlockDialogFragment {
     ...
     *           container, Bundle savedInstanceState) { /// load the custom
     *           layout View view =
     *           inflater.inflate(R.layout.fragment_changelog, container);
     *           mEditText = (EditText) view.findViewById(R.id.txt_your_name);
     *           getDialog().setTitle(R.string.whats_new);
     * 
     *           /// read full contents of the change log file (don't make it
     *           too big) InputStream changeLogStream =
     *           getResources().openRawResource(R.raw.changelog); Scanner
     *           scanner = new
     *           java.util.Scanner(changeLogStream).useDelimiter("\\A"); String
