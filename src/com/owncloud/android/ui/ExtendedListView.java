...
/**
 * ListView allowing to specify the position of an item that should be centered
 * in the visible area, if possible.
 * 
 * The cleanest way I found to overcome the problem due to getHeight() returns 0
 * until the view is really drawn.
 * 
...
public class ExtendedListView extends ListView {
     ...
     * 
     * @param position Position (in the list of items) of the item to center in
     *            the visible area.
     */
