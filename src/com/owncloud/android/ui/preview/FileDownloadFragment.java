...
public class FileDownloadFragment extends FileFragment implements OnClickListener {
    ...
    public void onClick(View v) {
        ...
        case R.id.cancelBtn: {
            ...
            if (downloaderBinder != null && downloaderBinder.isDownloading(mAccount, getFile())) {
                ...
                getActivity().finish(); // :)
                /*
                 * leaveTransferProgress(); if (mFile.isDown()) {
                 * setButtonsForDown(); } else { setButtonsForRemote(); }
                 */
            }
            break;
        }
     ...
     * 
     * @param transferring When true, the view must be updated assuming that the
     *            holded file is downloading, no matter what the
     *            downloaderBinder says.
     */
    public void updateView(boolean transferring) {
        // configure UI for depending upon local state of the file
        FileDownloaderBinder downloaderBinder = (mContainerActivity == null) ? null : mContainerActivity
